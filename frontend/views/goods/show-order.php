        ...
        <div class="order_bd mt10">
            <table class="orders">
                ...
                <tr>
                    ...
                    <?php $ordergoods = \frontend\models\OrderGoods::find()->where(['order_id'=>$order->id])->limit(3)->all()?>

                    <td>
                        <?php foreach ($ordergoods as $ordergood):?>
                        <a href="<?=\yii\helpers\Url::to(['goods/intro','id'=>$ordergood->goods_id])?>"><img src="<?=$ordergood->logo?>" alt="" /></a>
                        <?php endforeach;?>
                    </td>

                    <td><?=$order->name?></td>
                    <td><?=$order->delivery_price?><?=$order->payment_name?></td>
