...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <tbody>
        <?php $sum=0; foreach ($carts as $goods_id=>$amount):?>
        <tr goods-id="<?=$goods_id?>" amount="<?=$amount?>">
        ...
        <?php $sum+=($good->shop_price)*$amount; endforeach;?>
        </tbody>
        <tfoot>
        <tr>
            <td colspan="6">购物金额总计： <strong>￥ <span><?=$sum?>.00</span></strong></td>
        </tr>
        </tfoot>
    </table>
