        ...
        <div class="topnav_right fr">
            <ul>
                ...
                if(Yii::$app->user->isGuest){
                    echo <<<HTML
                <li>您好，欢迎来到京西！[<a href="/member/login.html">登录</a>] [<a href="/member/regist.html">免费注册</a>] </li>
HTML;
                }else{
                    $username = Yii::$app->user->identity->username;
                    echo <<<HTML
                <li>您好，欢迎回到京西！[$username] [<a href="/member/logout.html">退出</a>] </li>
HTML;
                }
                ?>
    ...
    <div class="logo w1210">
        ...
        <div class="search fl">
            <div class="search_form">
                ...
                <form action="<?=\yii\helpers\Url::to(['goods/search'])?>" method="get" class="fl">
                ...
                <dd>
                    <div class="prompt">
                        <?php if(Yii::$app->user->isGuest): ?>
                            ...
                            <?php else:?>
                                    欢迎回来(<?=Yii::$app->user->identity->username?>)
                        <?php endif;?>
                    ...
                    <div class="uclist mt10">
                        <ul class="list1 fl">
                            <li><a href="">用户信息></a></li>
                            <li><a href="">我的订单></a></li>
                            <li><a href="<?=\yii\helpers\Url::to(['member/dress'])?>">收货地址></a></li>
                            <li><a href="">我的收藏></a></li>
                        </ul>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                ...
                <div class="cat">
                    <h3><a href="<?=\yii\helpers\Url::to(['goods/show','id'=>$value->id])?>"><?=$value->name?></a><b></b></h3>
                    <div class="cat_detail none">
                        <?php $children = \backend\models\GoodsCategory::find()->where(['parent_id'=>$value->id])->all()?>
                        <?php foreach ($children as $child):?>
                            <dl class="dl_1st">
                            <dt><a href="<?=\yii\helpers\Url::to(['goods/show','id'=>$child->id])?>"><?=$child->name?></a></dt>
                            <?php $smallchildren = \backend\models\GoodsCategory::find()->where(['parent_id'=>$child->id])->all()?>
                            <?php foreach ($smallchildren as $smallchild):?>
                                <dd><a href="<?=\yii\helpers\Url::to(['goods/show','id'=>$smallchild->id])?>"><?=$smallchild->name?></a></dd>
                            <?php endforeach;?>
                        <?php endforeach;?>
                            </dl>
                    </div>
